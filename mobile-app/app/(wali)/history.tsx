...
export default function WaliHistoryScreen() {
  ...
  const filteredTickets = useMemo(() => {
    let result = allTickets.filter((t: any) => t.status !== 'pending'); // Show processed
...
const styles = StyleSheet.create({
  ...
  searchBar: {
    ...
    shadowColor: COLORS.primary, shadowOffset: { width: 3, height: 3 }, shadowOpacity: 1, shadowRadius: 0,
  ...
  filterPillActive: { backgroundColor: COLORS.primaryContainer, borderColor: 'transparent' },
